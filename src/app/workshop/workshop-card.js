...
export default function WorkshopCard({ name, img_src, register_link }) {
  return (
    <>
      <div className="mx-auto border-2 border-white rounded-4xl bg-gradient-to-br from-gray-800 blue-950 via-black to-green-800 w-[350px] hover:scale-105">
        ...
        <div className="flex justify-end">
          <div className="border-2 border-white m-3 rounded-br-4xl rounded-tl-4xl hover:bg-gradient-to-br from-green-800 to-black w-44 flex justify-center transition-colors">
