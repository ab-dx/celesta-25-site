...
export default function Register() {
  ...
  return (
    <div className={`p-6 md:p-10 ${styles.background} text-white flex flex-col items-center justify-center`}>
      <motion.div
        ...
        className="w-full"
      >
        <h1 className="font-bold text-6xl text-grad race mt-16 p-2">Register</h1>
      </motion.div>

      <form
        onSubmit={handleSubmit}
        className={`w-full max-w-4xl flex flex-col gap-8 p-6 md:p-10 ${styles.glassCard}`}
      >
            ...
            <>
              ...
              <div className="flex flex-col gap-2 text-xl">
                ...
                <input
                  ...
                  value={formData.name}
                  onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                  className="p-2 border-2 rounded-lg text-white bg-transparent focus:border-teal-600"
                  placeholder="Enter your name"
                  required
                />
              </div>
